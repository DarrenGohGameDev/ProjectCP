...
// IWYU pragma: private, include "Managers/CharacterMovementManager.h"
...
public: \
	DECLARE_CLASS(UCharacterMovementManager, UActorComponent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ProjectCP"), NO_API) \
...
private: \
	...
	UCharacterMovementManager(const UCharacterMovementManager&); \
public: \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UCharacterMovementManager); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UCharacterMovementManager); \
	DEFINE_DEFAULT_CONSTRUCTOR_CALL(UCharacterMovementManager) \
...
template<> PROJECTCP_API UClass* StaticClass<class UCharacterMovementManager>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_UE5Project_ProjectCP_ProjectCP_Source_ProjectCP_Public_Managers_CharacterMovementManager_h
