...
struct Z_CompiledInDeferFile_FID_UE5Project_ProjectCP_ProjectCP_Source_ProjectCP_Public_Character_Enemy_BaseEnemyCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABaseEnemyCharacter, ABaseEnemyCharacter::StaticClass, TEXT("ABaseEnemyCharacter"), &Z_Registration_Info_UClass_ABaseEnemyCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABaseEnemyCharacter), 3608692367U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE5Project_ProjectCP_ProjectCP_Source_ProjectCP_Public_Character_Enemy_BaseEnemyCharacter_h_1710939690(TEXT("/Script/ProjectCP"),
